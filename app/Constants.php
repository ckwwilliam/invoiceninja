...
if (! defined('APP_NAME')) {
    ...
    define('NINJA_WEB_URL', env('NINJA_WEB_URL', 'https://www.i-invoice.net'));
    define('NINJA_APP_URL', env('NINJA_APP_URL', 'https://app.i-invoice.net'));
    define('NINJA_DOCS_URL', env('NINJA_DOCS_URL', 'https://invoice-ninja.readthedocs.io/en/latest'));
    define('NINJA_DATE', '2000-01-01');
    define('NINJA_VERSION', '4.5.18' . env('NINJA_VERSION_SUFFIX'));
