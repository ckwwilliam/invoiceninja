...
<footer id="footer" role="contentinfo">
    ...
    <div class="bottom">
        <div class="wrap">
            @if (empty($account) || !$account->hasFeature(FEATURE_WHITE_LABEL))
            <!-- 
                <div class="copy">Copyright &copy;{{ date('Y') }} <a href="{{ NINJA_WEB_URL }}" target="_blank">i-invoice</a>. All rights reserved.</div>
            -->
            @endif
        </div><!-- .wrap -->
    </div><!-- .bottom -->
...
<!--<div class="fb-follow" data-href="https://www.facebook.com/invoiceninja" data-colorscheme="light" data-layout="button" data-show-faces="false"></div>-->
      ...
      <!--<div class="fb-like" data-href="https://www.i-invoice.net" data-layout="button" data-action="like" data-show-faces="false" data-share="false"></div>          -->
      <!--
      <div class="fb-share-button" data-href="https://www.i-invoice.net/" data-type="button"></div>
      &nbsp;

      <a href="https://twitter.com/share" class="twitter-share-button" data-url="https://www.i-invoice.net/" data-via="invoiceninja" data-related="hillelcoren" data-count="none" data-text="Free online invoicing">Tweet</a>
      <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
      &nbsp;
      <div class="g-plusone" data-size="medium" data-width="300" data-href="https://www.i-invoice.net/" data-annotation="none" data-count="false" data-recommendations="false"></div>
  ...
  -->
      ...
      <script type="IN/Share" data-url="https://www.i-invoice.net/"></script>
  -->
