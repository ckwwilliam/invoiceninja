...
<head>
    ...
    @else
        ...
        <meta property="og:site_name" content="i-invoice"/>
        <meta property="og:url" content="{{ SITE_URL }}"/>
        <meta property="og:title" content="i-invoice"/>
        ...
        <meta name="apple-mobile-web-app-title" content="i-invoice">
        <meta name="application-name" content="i-invoice">
