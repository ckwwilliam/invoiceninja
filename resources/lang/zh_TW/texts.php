...
$LANG = array(
    ...
    'confirmation_subject' => '確認在 Straw Hat 的帳號',
    ...
    'pro_plan_success' => '感謝您使用 Straw Hat 的專業版!<p/>&nbsp;<br/>
    ...
    'app_description' => 'Straw Hat 是一個為消費者建立發票、帳單的免費、開源工具。 使用Straw Hat ，您可輕易地從任何連網裝置建立並寄送美觀的發票。 您的客戶可列印您的發票、下載其 PDF 檔案，甚至在此系統內線上付款給您。',
    'rows' => 'rows',
    'www' => 'www',
    'logo' => '標誌',
    'subdomain' => '子網域',
    ...
    'pro_plan_feature4' => '移除 "Created by Straw Hat" 字樣',
    ...
    'white_label_text' => '購買一年的白牌授權 $:price，從發票和客戶門戶頁面中移除 Straw Hat 品牌。',
    ...
    'pro_plan_remove_logo' => ':link 來加入專業版，以移除 Straw Hat 標誌',
    ...
    'pro_plan_year_description' => '訂用 Straw Hat 專業版一年方案。',
    'pro_plan_month_description' => '訂用 Straw Hat 專業版一個月方案。',
    'enterprise_plan_product' => '企業方案',
    'enterprise_plan_year_description' => '訂用 Straw Hat 企業版一年方案。',
    'enterprise_plan_month_description' => '訂用 Straw Hat 企業版一個月方案。',
...
一旦您收到這兩筆款項，請回到這個付款方式頁面，並點擊帳號旁邊的「完成驗證」。',
    ...
    'export_help' => '若您計畫匯入資料到 Straw Hat ，請使用JSON。<br/>該檔案包含關於客戶、產品、發票、報價單與付款的資料。',
    ...
    'wepay_account_description' => '於 Straw Hat 使用的付款閘道',
    ...
    'bot_get_email' => '嗨! (wave)<br/>感謝您試用 Straw Hat 機器人。<br/>您需建立一個免費帳號以使用這個機器人。<br/>寄給我您的帳號所使用的電子郵件地址，以開始使用它。',
    'bot_get_code' => '感謝! 我已寄給您一封電子郵件，內有您的安全密碼。',
    'bot_welcome' => '好了，您的帳戶已經過驗證。<br/>',
    'email_not_found' => '我無法找到 :email 的可用帳戶',
    'invalid_code' => '密碼不正確',
    'security_code_email_subject' => 'Straw Hat 機器人的安全密碼',
    'security_code_email_line1' => '這是您的 Straw Hat 機器人安全密碼。',
    ...
    'warning' => '警告',
    'self-update' => '更新',
    'update_invoiceninja_title' => '更新 Straw Hat',
    'update_invoiceninja_warning' => '在開始更新 Straw Hat 之前，先備份您的資料庫與檔案!',
    'update_invoiceninja_available' => '有新版的 Straw Hat 可用。',
    'update_invoiceninja_unavailable' => 'Straw Hat 無更新的版本。',
