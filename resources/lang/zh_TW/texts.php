...
$LANG = array(
    ...
    'confirmation_subject' => '確認在 i-invoice 的帳號',
    ...
    'pro_plan_success' => '感謝您使用 i-invoice 的專業版!<p/>&nbsp;<br/>
                          <b>下一步</b><p/>一份待付的發票已寄送到您的帳號所使用的電子郵件地址
                          欲啟用專業版所有的厲害功能，請依循發票上的指示付款，以使用為期一年的專業級發票開立作業。<p/>
                         無法找到發票？需要進一步的協助? 我們樂於提供協助-- 請寫電子郵件給我們寄至 cs@i-invoice.net',
    ...
    'app_description' => 'i-invoice 是一個為消費者建立發票、帳單的免費、開源工具。 使用i-invoice ，您可輕易地從任何連網裝置建立並寄送美觀的發票。 您的客戶可列印您的發票、下載其 PDF 檔案，甚至在此系統內線上付款給您。',
    'rows' => 'rows',
    'www' => 'www',
    'logo' => '標誌',
    'subdomain' => '子網域',
    ...
    'more_actions' => '更多動作',
    'pro_plan_title' => 'I-invoice 專業版',
    'pro_plan_call_to_action' => '立即升級!',
    'pro_plan_feature1' => '建立無限數量的客戶',
    'pro_plan_feature2' => '開始使用 10 種美觀的發票設計',
    'pro_plan_feature3' => '自訂 URLs - "YourBrand.i-invoice.net"',
    'pro_plan_feature4' => '移除 "Created by i-invoice" 字樣',
    ...
    'color_font_help' => '注意: 主要色彩和字型也用於客戶門戶頁面和自訂電子郵件設計。',
    'live_preview' => '即時預覽',
    ...
    'white_label_text' => '購買一年的白牌授權 $:price，從發票和客戶門戶頁面中移除 i-invoice 品牌。',
    ...
    'pro_plan_remove_logo' => ':link 來加入專業版，以移除 i-invoice 標誌',
    ...
    'enable_client_portal' => '客戶門戶頁面',
    'enable_client_portal_help' => '顯示/隱藏客戶門戶頁面。',
    'enable_client_portal_dashboard' => '儀表板',
    'enable_client_portal_dashboard_help' => '在客戶門戶頁面顯示/隱藏儀表板頁。',
    ...
    'pro_plan_year_description' => '訂用 i-invoice 專業版一年方案。',
    'pro_plan_month_description' => '訂用 i-invoice 專業版一個月方案。',
    'enterprise_plan_product' => '企業方案',
    'enterprise_plan_year_description' => '訂用 i-invoice 企業版一年方案。',
    'enterprise_plan_month_description' => '訂用 i-invoice 企業版一個月方案。',
...
一旦您收到這兩筆款項，請回到這個付款方式頁面，並點擊帳號旁邊的「完成驗證」。',
    ...
    'export_help' => '若您計畫匯入資料到 i-invoice ，請使用JSON。<br/>該檔案包含關於客戶、產品、發票、報價單與付款的資料。',
    ...
    'wepay_account_description' => '於 i-invoice 使用的付款閘道',
    ...
    'bot_get_email' => '嗨! (wave)<br/>感謝您試用 i-invoice 機器人。<br/>您需建立一個免費帳號以使用這個機器人。<br/>寄給我您的帳號所使用的電子郵件地址，以開始使用它。',
    'bot_get_code' => '感謝! 我已寄給您一封電子郵件，內有您的安全密碼。',
    'bot_welcome' => '好了，您的帳戶已經過驗證。<br/>',
    'email_not_found' => '我無法找到 :email 的可用帳戶',
    'invalid_code' => '密碼不正確',
    'security_code_email_subject' => 'i-invoice 機器人的安全密碼',
    'security_code_email_line1' => '這是您的 i-invoice 機器人安全密碼。',
    ...
    'warning' => '警告',
    'self-update' => '更新',
    'update_invoiceninja_title' => '更新 i-invoice',
    'update_invoiceninja_warning' => '在開始更新 i-invoice 之前，先備份您的資料庫與檔案!',
    'update_invoiceninja_available' => '有新版的 i-invoice 可用。',
    'update_invoiceninja_unavailable' => 'i-invoice 無更新的版本。',
    ...
    'go_ninja_pro' => '前往 I-invoice 專業版!',
    'go_enterprise' => '前往企業版!',
    'upgrade_for_features' => '升級以使用更多功能',
    'pay_annually_discount' => '年繳 10 個月的月費，即享有 2 個月免費!',
    'pro_upgrade_title' => 'I-invoice 專業版',
    'pro_upgrade_feature1' => '您的品牌.i-invoice.net',
    ...
    'contact_us_for_register' => '如有興趣, 請透過電郵 cs@i-invoice.net 聯絡我們',
...
<ul><li>以彈性的商營運方式進行貸款與發票結帳。</li></ul>',
    ...
    'delivery_note' => '寄送註記',
    'show_tasks_in_portal' => '在客戶門戶頁面顯示任務',
    ...
    'improve_client_portal_link' => '設定子域名以縮短客戶門戶頁面連結。',
    ...
    'client_must_be_active' => '錯誤: 客戶必須處於使用中',
    'purge_client' => '清除客戶',
    ...
    'local_part_help' => '自訂入站支援電子郵件的本地部分, 即。YOUR_NAME@support.i-invoice.net',
    ...
    'create_ticket' => '建立票證',
    'allow_inbound_email_tickets_external' => '透過電子郵件的新票證 (客戶)',
